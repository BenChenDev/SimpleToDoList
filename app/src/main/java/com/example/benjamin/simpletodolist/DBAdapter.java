...
public class DBAdapter {
    ...
    public static final String KEY_DUEDAY = "dueDay";
    public static final String KEY_REPEAT = "repeat";

    public static final int COL_TASK = 1;
    public static final int COL_DUEDAY = 2;
    public static final int COL_REPEAT = 3;

    public static final String[] ALL_KEYS = new String[]{KEY_ROWID, KEY_TASK, KEY_DUEDAY, KEY_REPEAT};
    ...
    public long insertRow(String task, String dueDay, String repeat) {
        // [TO_DO_A8]
        ...
        initialValues.put(KEY_DUEDAY, dueDay);
...
//    public boolean updateRow(String task, String datetime, String repeat) {
